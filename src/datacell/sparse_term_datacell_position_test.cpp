...
TEST_CASE("SparseTermDataCell Position Storage Cap", "[ut][SparseTermDatacell][Position]") {
    ...
    SparseTermDataCell cell(
        1.0f, 100, allocator.get(), SparseValueQuantizationType::FP32, nullptr, store_positions, max_positions_per_term);
...
TEST_CASE("SparseTermDataCell Position Storage Disabled", "[ut][SparseTermDatacell][Position]") {
    ...
    SparseTermDataCell cell(1.0f, 100, allocator.get(), SparseValueQuantizationType::FP32, nullptr, store_positions, 64);
...
TEST_CASE("SparseTermDataCell Position Serialize Deserialize",
    ...
    SparseTermDataCell cell2(1.0f, 100, allocator.get(), SparseValueQuantizationType::FP32, nullptr, store_positions, 64);
